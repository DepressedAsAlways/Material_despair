...
.field private b:Lkik/android/chat/vm/aq;

.field private c:Lkik/android/chat/vm/bh;
...
.method public handleBackPress()Z
    ...
    .prologue
    .line 74
    iget-object v0, p0, Lkik/android/chat/fragment/InterestsPickerFragment;->b:Lkik/android/chat/vm/aq;

    invoke-interface {v0}, Lkik/android/chat/vm/aq;->n_()Lrx/d;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0}, Lkik/android/chat/fragment/InterestsPickerFragment$a;->j_()Ljava/util/List;

    move-result-object v0

    invoke-direct {v1, v0}, Lkik/core/chat/profile/ag;-><init>(Ljava/util/List;)V

    iput-object v1, p0, Lkik/android/chat/fragment/InterestsPickerFragment;->d:Lkik/core/chat/profile/ag;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iget-object v3, p0, Lkik/android/chat/fragment/InterestsPickerFragment;->d:Lkik/core/chat/profile/ag;
    ...
    invoke-direct {v2, v3, v4}, Lkik/android/chat/l;-><init>(Lkik/core/chat/profile/ag;I)V

    .line 61
    new-instance v3, Lkik/android/chat/vm/bw;

    invoke-direct {v3, v2}, Lkik/android/chat/vm/bw;-><init>(Lkik/android/chat/l;)V

    iput-object v3, p0, Lkik/android/chat/fragment/InterestsPickerFragment;->b:Lkik/android/chat/vm/aq;

    .line 62
    iget-object v3, p0, Lkik/android/chat/fragment/InterestsPickerFragment;->b:Lkik/android/chat/vm/aq;

    invoke-virtual {p0, v3}, Lkik/android/chat/fragment/InterestsPickerFragment;->attachVm(Lkik/android/chat/vm/br;)Lkik/android/chat/vm/br;
    ...
    .line 65
    new-instance v3, Lkik/android/chat/vm/ds;

    invoke-direct {v3, v2}, Lkik/android/chat/vm/ds;-><init>(Lkik/android/chat/l;)V

    iput-object v3, p0, Lkik/android/chat/fragment/InterestsPickerFragment;->c:Lkik/android/chat/vm/bh;

    .line 66
    iget-object v2, p0, Lkik/android/chat/fragment/InterestsPickerFragment;->c:Lkik/android/chat/vm/bh;

    invoke-virtual {p0, v2}, Lkik/android/chat/fragment/InterestsPickerFragment;->attachVm(Lkik/android/chat/vm/br;)Lkik/android/chat/vm/br;
