...
.method static synthetic a(Lkik/android/chat/activity/KikApiLandingActivity;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0, p2, p1}, Lkik/android/chat/activity/d;->a(Lkik/android/chat/activity/KikApiLandingActivity;Ljava/lang/String;Ljava/lang/String;)Lrx/functions/b;

    move-result-object v1

    invoke-static {p0}, Lkik/android/chat/activity/e;->a(Lkik/android/chat/activity/KikApiLandingActivity;)Lrx/functions/b;
...
.method static synthetic a(Lkik/android/chat/activity/KikApiLandingActivity;Ljava/lang/String;Ljava/lang/String;Lcom/kik/core/domain/a/a/c;)V
    ...
    invoke-virtual {v1, v2}, Lkik/android/chat/vm/profile/do;->a(Lkik/core/datatypes/MemberPermissions;)Lkik/android/chat/vm/profile/do;
...
.method static synthetic a(Lkik/android/chat/activity/KikApiLandingActivity;Ljava/util/Map;Ljava/lang/String;ZZ)V
    ...
    invoke-static {v4}, Lkik/android/chat/vm/profile/do;->a(Lcom/kik/core/network/xmpp/jid/a;)Lkik/android/chat/vm/profile/do;

    move-result-object v4

    .line 3433
    invoke-virtual {v4, v0}, Lkik/android/chat/vm/profile/do;->a(Lkik/core/datatypes/MemberPermissions;)Lkik/android/chat/vm/profile/do;

    move-result-object v0

    .line 3434
    invoke-virtual {v0, v3}, Lkik/android/chat/vm/profile/do;->a(Lkik/android/chat/a/a$b;)Lkik/android/chat/vm/profile/do;
    ...
    invoke-static {p0, p2}, Lkik/android/chat/activity/b;->a(Lkik/android/chat/activity/KikApiLandingActivity;Ljava/lang/String;)Lrx/functions/b;

    move-result-object v1

    invoke-static {p0}, Lkik/android/chat/activity/c;->a(Lkik/android/chat/activity/KikApiLandingActivity;)Lrx/functions/b;
...
.method private f()Lkik/android/chat/vm/ay;
    ...
    invoke-direct {v0, p0}, Lkik/android/chat/vm/bz;-><init>(Landroid/content/Context;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v0, p0, Lkik/android/chat/activity/KikApiLandingActivity;->h:Lkik/android/util/s;

    invoke-virtual {v0}, Lkik/android/util/s;->a()Z
