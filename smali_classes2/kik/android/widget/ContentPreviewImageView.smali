...
.method static synthetic a(Lkik/arcane/widget/ContentPreviewImageView;Landroid/graphics/Bitmap;)V
    ...
    .line 52
    :cond_0
    instance-of v2, v0, Lkik/arcane/widget/bg;

    if-eqz v2, :cond_2

    .line 53
    check-cast v0, Lkik/arcane/widget/bg;

    .line 55
    invoke-virtual {v0}, Lkik/arcane/widget/bg;->b()Landroid/graphics/Bitmap;
    ...
    .line 66
    :cond_1
    new-instance v1, Lkik/arcane/widget/bg;

    invoke-direct {v1, p1}, Lkik/arcane/widget/bg;-><init>(Landroid/graphics/Bitmap;)V

    .line 68
    invoke-virtual {v1}, Lkik/arcane/widget/bg;->a()V

    .line 69
    invoke-virtual {v1, p0}, Lkik/arcane/widget/bg;->setCallback(Landroid/graphics/drawable/Drawable$Callback;)V

    .line 70
    invoke-virtual {v1, v0, p1}, Lkik/arcane/widget/bg;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V
...
.method public static a(Lkik/arcane/widget/ContentPreviewImageView;Lrx/d;)V
    ...
    invoke-static {p0}, Lkik/arcane/widget/al;->a(Lkik/arcane/widget/ContentPreviewImageView;)Lrx/functions/b;

    move-result-object v1

    const/4 v2, 0x0

    invoke-static {p0}, Lkik/arcane/widget/am;->a(Lkik/arcane/widget/ContentPreviewImageView;)Ljava/lang/Runnable;
...
.method public static b(Lkik/arcane/widget/ContentPreviewImageView;Lrx/d;)V
    ...
    invoke-static {p0}, Lkik/arcane/widget/an;->a(Lkik/arcane/widget/ContentPreviewImageView;)Lrx/functions/b;

    move-result-object v1

    const/4 v2, 0x0

    invoke-static {p0}, Lkik/arcane/widget/ao;->a(Lkik/arcane/widget/ContentPreviewImageView;)Ljava/lang/Runnable;
...
.method public setImageDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p1}, Lkik/arcane/widget/ap;->a(Landroid/graphics/drawable/Animatable;)Ljava/lang/Runnable;
