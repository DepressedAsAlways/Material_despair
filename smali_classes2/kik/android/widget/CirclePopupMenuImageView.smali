...
.field private c:Lkik/arcane/chat/vm/aw;
...
.method private a()V
    ...
    .prologue
    .line 73
    invoke-static {p0}, Lkik/arcane/widget/ag;->a(Lkik/arcane/widget/CirclePopupMenuImageView;)Landroid/view/View$OnClickListener;
...
.method private a(Lkik/arcane/chat/vm/aw;)V
    .locals 0
    ...
    .line 110
    iput-object p1, p0, Lkik/arcane/widget/CirclePopupMenuImageView;->c:Lkik/arcane/chat/vm/aw;
...
.method static synthetic a(Lkik/arcane/widget/CirclePopupMenuImageView;)V
    ...
    .prologue
    .line 75
    iget-object v0, p0, Lkik/arcane/widget/CirclePopupMenuImageView;->c:Lkik/arcane/chat/vm/aw;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lkik/arcane/widget/CirclePopupMenuImageView;->c:Lkik/arcane/chat/vm/aw;

    invoke-interface {v0}, Lkik/arcane/chat/vm/aw;->aj_()Lrx/d;
    ...
    iget-object v1, p0, Lkik/arcane/widget/CirclePopupMenuImageView;->c:Lkik/arcane/chat/vm/aw;

    invoke-interface {v1}, Lkik/arcane/chat/vm/aw;->aj_()Lrx/d;

    move-result-object v1

    invoke-static {p0}, Lkik/arcane/widget/ah;->a(Lkik/arcane/widget/CirclePopupMenuImageView;)Lrx/functions/b;
...
.method public static a(Lkik/arcane/widget/CirclePopupMenuImageView;Lkik/arcane/chat/vm/aw;)V
    .locals 0
    ...
    .prologue
    .line 31
    invoke-direct {p0, p1}, Lkik/arcane/widget/CirclePopupMenuImageView;->a(Lkik/arcane/chat/vm/aw;)V

    .line 32
    return-void
.end method

.method static synthetic a(Lkik/arcane/widget/CirclePopupMenuImageView;Lkik/arcane/chat/vm/cw;)V
    .locals 7
    ...
    .line 82
    invoke-virtual {p1}, Lkik/arcane/chat/vm/cw;->a()Ljava/util/List;
    ...
    invoke-interface {v0}, Lkik/arcane/chat/vm/aw;->ak_()V
    ...
    invoke-static {p0}, Lkik/arcane/widget/ai;->a(Lkik/arcane/widget/CirclePopupMenuImageView;)Landroid/widget/PopupMenu$OnDismissListener;
    ...
    invoke-static {p1}, Lkik/arcane/widget/aj;->a(Lkik/arcane/chat/vm/cw;)Landroid/widget/PopupMenu$OnMenuItemClickListener;
...
.method public static a(Lkik/arcane/widget/CirclePopupMenuImageView;Lkik/arcane/chat/vm/messaging/ep;)V
    .locals 0
    .annotation build Landroid/databinding/BindingAdapter;
        value = {
            "model"
...
.method static synthetic a(Lkik/arcane/chat/vm/cw;Landroid/view/MenuItem;)Z
    .locals 1
    ...
    invoke-virtual {p0, v0}, Lkik/arcane/chat/vm/cw;->a(I)Z
...
.method static synthetic b(Lkik/arcane/widget/CirclePopupMenuImageView;)V
    ...
    invoke-interface {v0}, Lkik/arcane/chat/vm/aw;->f()V
