...
.method public static a(Landroid/view/ViewGroup;Landroid/content/Context;Lcom/kik/components/CoreComponent;Lkik/core/datatypes/messageExtensions/ContentMessage;Ljava/lang/String;Landroid/widget/LinearLayout;Lkik/android/util/m$a;)Landroid/view/View;
    .locals 10
    ...
    check-cast v6, Lkik/android/e/d;

    .line 59
    invoke-virtual {v6}, Lkik/android/e/d;->getRoot()Landroid/view/View;
    ...
    .line 65
    iget-object v0, v6, Lkik/android/e/d;->c:Landroid/databinding/ViewStubProxy;
    ...
    .line 70
    invoke-static {p3}, Lkik/android/chat/vm/messaging/a/c;->a(Lkik/core/datatypes/messageExtensions/ContentMessage;)Z
    ...
    invoke-virtual {v0}, Lkik/android/chat/vm/messaging/a/a;->p()Z

    move-result v4

    .line 92
    :goto_1
    iget-object v9, v6, Lkik/android/e/d;->b:Landroid/widget/Button;
    ...
    invoke-static/range {v0 .. v5}, Lkik/android/util/n;->a(Landroid/widget/LinearLayout;Lkik/android/widget/BubbleFramelayout;Lkik/android/util/m$a;Ljava/lang/String;ZLkik/core/datatypes/messageExtensions/ContentMessage;)Landroid/view/View$OnClickListener;
    ...
    invoke-direct {v0, p1}, Lkik/android/chat/vm/bz;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v6, v2, v7}, Lkik/android/e/d;->setVariable(ILjava/lang/Object;)Z
    ...
    .line 74
    :cond_2
    invoke-static {p3}, Lkik/android/chat/vm/messaging/a/b;->a(Lkik/core/datatypes/messageExtensions/ContentMessage;)Z
...
.method static synthetic a(Landroid/widget/LinearLayout;Lkik/android/widget/BubbleFramelayout;Lkik/android/util/m$a;Ljava/lang/String;ZLkik/core/datatypes/messageExtensions/ContentMessage;)V
    .locals 1
    ...
    invoke-interface {p2, p3, p4, v0}, Lkik/android/util/m$a;->a(Ljava/lang/String;ZLjava/lang/String;)V
